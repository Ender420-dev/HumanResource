...
INSERT INTO `critical_position` (`CRITICAL_ID`, `POSITION_TITLE`, `DEPARTMENT`, `INCUMBERT`, `SUCCESSORS`, `RISKLEVEL`, `STATUS`) VALUES
(3, 'IT Head', 'IT Department', 'vacant', NULL, NULL, NULL),
(4, 'IT Head', 'IT Department', 'vacant', 'none', NULL, NULL),
(5, 'IT Head', 'IT Department', 'vacant', 'none', 'High', 'Occupied'),
(6, 'IT Head', 'IT Department', 'vacant', 'none', 'High', 'Occupied'),
(7, 'IT Head', 'IT Department', 'vacant', 'none', 'Medium', 'Occupied');
...
(6, 2, 35, '2025-05-09', '2025-05-31', 'Ongoing', 4);
...
INSERT INTO `skill_qualification` (`SKILL_ID`, `SKILL`, `POSITION`) VALUES
(3, 'Treatment', 'Doctor'),
(4, 'Diagnosis', 'Doctor'),
(5, 'Communication', 'Doctor'),
(6, 'Empathy', 'Doctor'),
(7, 'Decision-making', 'Doctor'),
(8, 'Professionalism', 'Doctor');
...
INSERT INTO `succession_plan_dev` (`SUCCESSION_ID`, `SUCCESION_NAME`, `CURRENT_ROLE`, `READINESS_LEVEL`, `DEVELOPMENT_ACTIONS`, `TARGET_READINESS_DATE`, `MENTOR_ASSIGNED`, `PROGRESS`) VALUES
(1, 'Loyd Lleno', 'IT Head', 'Medium', '12-18 months', '2025-10-23', NULL, '20');
...
(6, 'John cardo dalosay', 5, '2025-05-22 02:29:21', '2025-05-14 10:37:05'),
...
--
ALTER TABLE `critical_position`
  MODIFY `CRITICAL_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `learning_progress`
  MODIFY `LP_ID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `skill_qualification`
  MODIFY `SKILL_ID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `succession_plan_dev`
--
ALTER TABLE `succession_plan_dev`
  MODIFY `SUCCESSION_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
