...
<div class="p-2 gap-3">
    ...
    <div class="container-fluid shadow-lg col p-4">
        ...
        <div class="alert alert-warning text-center" role="alert">
            <strong>Note:</strong> This page is currently running without a database. All approvals/rejections are **not persistent** and will disappear upon session clear, server restart, or after a certain time.
        </div>
