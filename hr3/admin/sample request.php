...
include_once '../connections.php'; // This should establish $conn_hr3 and $conn_hr4
    ...
    <div class="container-fluid shadow-lg col p-4">
        ...
        <form class="mb-4" method="GET" action="manage_leave_requests.php">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-4">
                    <label for="employee_name_filter" class="form-label">Filter by Employee Name:</label>
                    <input type="text" class="form-control" id="employee_name_filter" name="employee_name_filter" value="<?= htmlspecialchars($filter_employee_name) ?>" placeholder="e.g., John Doe">
                </div>
                <div class="col-md-4">
            ...
            <div class="modal-body">
                <form id="leaveRequestForm">
                    ...
                    <div class="mb-3">
                        ...
                        <span id="modalDocumentPath">N/A</span>
                    </div>
...
$(document).ready(function() {
    ...
    $('.view-manage-btn').on('click', function() {
        ...
        $.ajax({
            url: 'get_leave_request_details.php', // New PHP script
            type: 'GET',
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    $('#modalLeaveType').val(data.leave_type_name);
                    ...
                    $('#modalApprovedBy').val(data.approver_first_name ? data.approver_first_name + ' ' + data.approver_last_name : 'N/A');
                    $('#modalApprovedAt').val(data.approved_at ? data.approved_at : 'N/A');
                    $('#modalApproverComments').val(data.approver_comments ? data.approver_comments : 'N/A');

                    if (data.document_path) {
                        $('#modalDocumentPath').html('<a href="' + data.document_path + '" target="_blank">View Document</a>');
                    } else {
                        $('#modalDocumentPath').text('N/A');
                    }
    ...
    // Event listener for "Save Status Changes" button in the modal
    $('#saveStatusBtn').on('click', function() {
        ...
        if (!requestId || !newStatus) {
            statusMessageDiv.text('Missing request ID or new status.').addClass('alert-danger').show();
            return;
        }

        $.ajax({
            url: 'update_leave_request_status.php', // New PHP script
            type: 'POST',
            data: {
